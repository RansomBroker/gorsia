        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit Data /</span> Check Out</h4>
              <div class="card" >
                    <h5 class="card-header">Data Check Out</h5>
                ...
                <div class="col-xl">
                  <div class="card mb-12">
                    ...
                    <div class="card-body">
                      <form method="post" action="<?php base_url() ?>?/CheckInOut/update/<?= $data->id ?>">
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Kode Member</label>
                            <input type="text" class="form-control" id="kodeMember" name="kodeMember" value="<?= $data->kodeMember ?>" readonly />
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="no_telepon" name="no_telepon" value="<?= $data->no_telepon ?>" required readonly />
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Check In</label>
                            <input type="text" class="form-control" id="checkIn" name="checkIn" placeholder="Check In" value="<?= $data->checkIn ?>" required readonly />
                          </div>
                          <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">Check Out</label>
                            <input type="time" class="form-control" id="checkOut" name="checkOut" placeholder="Check Out" required />
                          </div>
                        </div>
                      </div>
