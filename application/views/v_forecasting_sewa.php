          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="text-center">
                  Forecasting Jumlah Sewa 6 Bulan Terakhir
                </div>
                <?php echo form_open('Forecasting/sewa'); ?>
                <div class="row">
                  <div class="col-md-6">
      ...
      $(document).ready(function () {
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Badminton',
                    data: <?php echo json_encode(array_values($datasets['badminton'])); ?>,
                    borderWidth: 3
                },
                {
                    label: 'Futsal',
                    data: <?php echo json_encode(array_values($datasets['futsal'])); ?>,
                    borderWidth: 2
                }]
