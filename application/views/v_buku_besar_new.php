...
<?php if ($this->uri->segment('2') == 'filterpencarian' && false) {
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select multiple class="form-select" style="width: 100%" name="txt_id_akun[]" id="txt_id_akun" required>
                                                    <option value="all" <?= in_array('all', $param_id_akun)
                                                        ? 'selected'
                                                        : '' ?>>Semua</option>
                                                    <?php foreach ($get_all_data_akun as $row) {
                                                        ...
                                                        $selected = in_array($row->id_kode_akuntansi, $param_id_akun)
                                                            ? 'selected'
                                                            : '';
                                            ...
                                            <div class="col-md-3 d-flex gap-3 align-items-end justify-content-end">
                                                ...
                                                <a href="<?= site_url(
                                                    '?/BukuBesar/exportPdf?periode=' .
                                                        $periode .
                                                        '&tahun=' .
                                                        $tahun .
                                                        '&txt_id_akun[]=' .
                                                        implode('&txt_id_akun[]=', $param_id_akun)
                                                ) ?>"
       class="btn btn-danger" target="_blank" id="export_pdf_btn">
                                        ...
                                        foreach ($get_all_buku_besar as $row) {
                                            ...
                                            if ($temp != $row->id_kode_akuntansi) {
                                                ...
                                                $query_saldo_awal = $this->db
                                                    ...
                                                    WHERE id_kode_akuntansi='" .
                                                            $temp2 .
                                                            "' 
                                                    AND jurnal_umum.tanggal < '" .
                                                            $first_periode .
                                                            "'
                                                    GROUP BY id_kode_akuntansi
                                                "
                                                    ...
                                                    ->row_array();
                                                $saldo_awal_debet = $query_saldo_awal
                                                    ? $query_saldo_awal['total_debet']
                                                    : 0;
                                                $saldo_awal_kredit = $query_saldo_awal
                                                    ? $query_saldo_awal['total_kredit']
                                                    : 0;
                                                ...
                                                echo '<td></td>';
                                                echo '<td></td>';
                                                echo "<td>Rp. <span class='float-end'>" .
