...
>
  <head>
    ...
    <title>Login Sistem Akuntansi GOR</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <img src="assets/backend/img/favicon/favicon.ico" width="30px">
                  </span>
                  <span class="app-brand-text demo text-body fw-bolder">GORSIA</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to GORSIA ! 👋</h4>
              <p class="mb-4">Please sign-in to your account</p>

              <form id="formAuthentication" class="mb-3" action="<?=site_url();?>?/Login/aksi_login" method="POST">
                <div class="mb-3">
