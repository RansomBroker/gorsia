        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit Data /</span> Pelanggan Sewa</h4>
              <div class="card" >
                ...
                <div class="col-xl">
                  <div class="card mb-12">
                    ...
                    <div class="card-body">
                      <form method="post" action="<?php base_url() ?>?/MemberPelanggan/update/<?= $data->id ?>">
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-3">
                            <label class="form-label" for="basic-default-fullname">ID Member</label>
                            <input type="text" class="form-control" id="id_member" name="id_member" value="<?= $data->id_member ?>" readonly />
                        ...
                        <!-- <div class="col-6">
                          <div class="mb-3">
                            ...
                            <input type="radio" id="status" name="status" value="1" <?php if ($data->status == '1') { ?>
                              checked
                            <?php } ?>>
                            <label for="status"> Ya</label><br>
                            <input type="radio" id="status2" name="status" value="0" <?php if ($data->status == '0') { ?>
                            checked
                            <?php } ?>>
