...
<head>
  ...
  <title>Gorsia - Jadwal Sesi</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Data /</span> Jadwal Sesi</h4>


              <div class="row">
                <?php
                echo form_open_multipart(site_url().'?/JadwalSesi/insert_data'); 
                ?>
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Isi data jadwal sesi</h5>
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Jam Sesi</label>
                          <input type="text" class="form-control" id="jam_sesi" name="jam_sesi" placeholder="Isi jam sesi" required />
                        </div>
              ...
              <div class="card">
                ...
                <h5 class="card-header">Data Jadwal Sesi</h5>
                    ...
                    <tbody class="table-border-bottom-0">
                     ...
                     foreach($get_all_jadwal_sesi as $row) {    
                      ...
                      if ($akses_update=="Aktif"){
                        ...
                        echo '<a data-bs-toggle="modal" data-bs-target="#modal-update-data'.$id_jadwal_sesi.'"><i class="bx bx-edit-alt me-2"></i>Edit</a>'; echo '&nbsp;&nbsp;' ;}
                        if ($akses_delete=="Aktif"){
                          echo '<a onclick="return konfirm_hapus()" href="'.site_url().'?/JadwalSesi/delete_data/id/'.$id_jadwal_sesi.'"><i class="bx bx-trash me-2"></i> Delete</a>';}
                          echo '</td><tr>';

                          echo form_open_multipart(site_url().'?/JadwalSesi/update_data'); 
                          echo '<div class="modal fade" id="modal-update-data'.$id_jadwal_sesi.'" tabindex="-1" aria-hidden="true" style="display: none;">

                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1">Edit Jadwal Sesi</h5>
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  ...
                                  <div class="col mb-3">
                                    ...
                                    <input type="hidden" id="id_jadwal_sesi" name="id_jadwal_sesi" class="form-control" placeholder="" value="'.$id_jadwal_sesi.'" required="">
                                     <select class="form-select" id="kategori_olahraga" name="kategori_olahraga" aria-label="Default select example" required>
                                  ...
                                  <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">Jam Sesi</label>
                                    <input type="text" class="form-control" id="jam_sesi" name="jam_sesi" placeholder="Isi nama lapangan" value="'.$jam_sesi.'" required />
                                  </div>
