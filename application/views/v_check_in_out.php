        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi /</span> Check In</h4>
              <div class="card" >
                ...
                <div class="table-responsive text-nowrap p-3">
                  <a href="<?= site_url() ?>?/CheckInOut/create" class="btn btn-primary" style="float: right;">
          ...
          <?php $no = 1; ?>
            ...
            ?>
					<tr>
						...
						<td><?= $key['kodeMember'] ?></td>
						<td><?= $key['nama'] ?></td>
						<td><?= $key['no_telepon'] ?></td>
						<td><?= $key['checkIn'] ?></td>
						<td>
            <?php if ($key['checkOut'] == null) { ?>
            <a  href="<?php echo base_url() . "?/CheckInOut/edit/$key[id]" ?>">Check Out </a>
            <?php } ?>
            <a  href="<?php echo base_url() . "?/CheckInOut/show/$key[id]" ?>"><i class="bx bx-show me-2"></i> </a>
            <a  href="<?php echo base_url() . "?/CheckInOut/delete/$key[id]" ?>"><i class="bx bx-trash me-2"></i> </a>
            </td>
					</tr>
					<?php $no++;
            } ?>
