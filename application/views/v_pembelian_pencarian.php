...
<head>
  ...
  <title>Gorsia - Pencarian Pembelian</title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
               ...
               <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Pencarian Pembelian</h4>
                                <h6 class="card-subtitle">Cari data pembelian</h6>
                               <hr>


                                <?php   echo '<a href="'.site_url().'?/Pembelian" class="btn btn-sm btn-outline-primary"><i class="bx bx-book-add"></i> Baru</a>';
                                ?>
                                <br>
                                <br>
                                ...
                                <div class="table-responsive text-nowrap">
                                    <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable" style="padding: 5px; font-size: 12px; white-space: nowrap;">
                                        <thead>
                                <tr role="row">
                                    <th><b>No. Pembelian</b></th>
                                    <th><b>Tanggal</b></th>
                                    <th><b>Suplier</b></th>
                                    <th><b>Nota</b></th>
                                    <th><b>Cara Bayar</b></th>
                                    <th><b>Total</b></th>
                                    <th><b>View</b></th>
                            ...
                            <tbody>
                                  ...
                                  <?php foreach($get_all_data_pembelian as $row) {    
                                      ...
                                      #kode suplier
                                      $rows_spl = $this->db->query("SELECT * FROM suplier where kode_suplier='".$kode_suplier."'")->row_array();
                                      $nama_suplier=$rows_spl['nama_suplier'];

                                      echo '<tr role="row" >
                                      <td>'.$no_pembelian.'</td>
                                      <td>'.date("d/m/Y", strtotime($tanggal)).'</td>
                                      <td>'.$nama_suplier.'</td>
                                      <td>'.$nota_pembelian.'</td>
                                      <td>'.$cara_bayar.'</td>
                                      <td>'.number_format($total).'</td>

                                      <td align="center">';
                                      if ($akses_update=="Aktif"){
                                        echo '<a href="'.site_url().'?/Pembelian/viewer/no/'.$no_pembelian.'"><i class="bx bx-edit-alt"></i></a>' ;}
...
<script src="assets/vendor/jquery-datatable/buttons/buttons.print.min.js"></script>
 ...
 var table_pencarian = $('#myTable').DataTable({
                                            ...
                                            { extend:'excel', title: "Pembelian" , footer: true }, 
                                            { extend:'pdf', orientation: 'landscape', title: "Pembelian" , footer: true }, 
