              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-12">
                    <div class="card-body">
                      <form onsubmit="return validateBalance()" method="post" action="<?= base_url() ?>?/Pengeluaran/update/<?= $data->id ?>">
                        <div class="row">
                          <div class="col-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3" id="container-sumber">
                              ...
                              <?php
                                $rows_detail = $this->db->query("SELECT * FROM transaksi_pengeluaran_detil where no_transaksi='".$data->no_transaksi."'")->result_array();                              
                              ?>
                              <?php foreach ($rows_detail as $val) {
                              ?>
                                <?php
                                if ($val['id_kode_akun_kredit']) {
                                ?>
                                <div class="row d-flex mt-2">
                                  <div class="col-4">
                                    <input type="number" class="form-control" id="nominal1" name="nominal1[]" value="<?= $val['nominal'] ?>"/>
                                  </div>
                                  <div class="col-6">
                            ...
                            <div class="mb-3" id="container-tujuan">
                              ...
                              ?>
                                <?php
                                if ($val['id_kode_akun_debet']) {
                                ?>
                                <div class="row d-flex mt-2">
                                  <div class="col-4">
                                    <input type="number" class="form-control" id="nominal2" name="nominal2[]" value="<?= $val['nominal'] ?>"/>
                                  </div>
                                  <div class="col-6">
                            ...
                            <?php if($data->status_transaksi == 'Sukses') { ?>
                              <a class="btn btn-danger text-white" href="<?= base_url() ?>?/Pengeluaran/void/<?= $data->id ?>">Void</a>
                            <?php } ?>
                          </div>
                        </div>
                      </form>
