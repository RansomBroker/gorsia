...
<body>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form Data /</span> Jurnal Lain</h4>
            <div class="card">
              <h5 class="card-header">Data Jurnal Lain</h5>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-12">
                    <div class="card-body">
                      <form onsubmit="return validateBalance()" method="post" action="<?= base_url() ?>?/Jurnal/store">
                        <div class="row">
                          <div class="col-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3" id="container-sumber">
                              <label class="form-label" for="basic-default-fullname">Debit</label>
  ...
  <script type="text/javascript">
    ...
    function tambah_sumber() {
        ...
        // Dapatkan option dari elemen referensi #parents
        let option = $("#parents").html();
        // Hilangkan ID agar tidak duplikasi dan gunakan class saja
        ...
        // Inisialisasi select2 hanya pada select yang baru saja ditambahkan
    ...
    function tambah_tujuan() {
        ...
        // Inisialisasi select2 pada elemen select baru
        $(newElement).find('.select2').select2();
    }
