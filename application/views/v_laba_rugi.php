                        ...
                        <tbody>
                          ...
                          foreach ($get_all_parent_akun_laba_rugi as $row) {
                            ...
                            foreach ($query_akun->result() as $row_akun) {
                              ...
                              $query_jurnal = $this->db->query("SELECT sum(debet) as total_debet_mutasi, sum(kredit) as total_kredit_mutasi FROM jurnal_umum INNER JOIN jurnal_umum_detail ON jurnal_umum.no_bukti=jurnal_umum_detail.no_bukti WHERE id_kode_akuntansi='" . $id_akun_level_2 . "' AND periode='" . $param_periode . "' GROUP BY id_kode_akuntansi")->row_array();
