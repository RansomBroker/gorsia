...
<?php
function cek_saldo($saldo)
{
  if ($saldo < 0) {
    return "(Rp. " . number_format(abs($saldo)) . ")";
  } else {
...
<body>
      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Akuntansi /</span> Laba Rugi
            </h4>
              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="card-subtitle">rangkuman laba rugi</h6>
                    <hr>


                    <div class="row">
                      <div class="col-sm-6 col-xs-12">
                        <?php echo form_open_multipart(site_url() . '?/LabaRugi/filterpencarian'); ?>
                      ...
                      <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable" style="padding: 5px; font-size: 12px; white-space: nowrap;">
                        <thead>
                          <tr role="row">
                            ...
                            <th style="width: 100px;"><b>Laba (Rugi)</b></th>
                          </tr>
                        </thead>
                        ...
                        <tbody>
                          ...
                          $total = 0;
                          foreach ($get_all_parent_akun_laba_rugi as $row) {
                              echo "<tr>";
                              ...
                              foreach ($child as $row2) {
                                ...
                                if($row->nama_akun == "PAJAK"){
                                  $total_akun = abs($total) * 11 / 100;
                                  echo "<tr>";
                                  echo "<td class='ps-5'>$row2->nama_akun</td>";
                                  echo "<td align='right'>" . cek_saldo($total * 11 / 100) . "</td>";
                                  echo "</tr>";
                                  // $total = $total - $temp;
                                  continue;
                                }
                              ...
                              if($row->nama_akun == "PAJAK"){
                                ...
                                echo "<td><b>Total Laba (Rugi) Setelah Pajak</b></td>";
                                if($total > 0){
                                  echo "<td align='right' class='font-weight-bold'>".cek_saldo($total + $total_akun)."</td>";
                                }else{
                                  echo "<td align='right' class='font-weight-bold'>".cek_saldo($total - $total_akun)."</td>";
                                }
                                echo "</tr>";
                                ...
                                echo "<tr class='bg-gray-400' style='background-color: #f8f9fa'>";
                                echo "<td><b>Total Laba (Rugi) $row->nama_akun</b></td>";
                                echo "<td align='right' class='font-weight-bold'>".cek_saldo($total_akun)."</td>";
                                echo "</tr>";
                              }
                              if($row->nama_akun == "BEBAN USAHA"){
                                echo "<tr class='bg-gray-400' style='background-color: #f8f9fa'>";
                                echo "<td><b>Total Laba (Rugi) Sebelum Pajak</b></td>";
                                echo "<td align='right' class='font-weight-bold'>".cek_saldo($total)."</td>";
                                echo "</tr>";
                              }
                        }
                        // foreach ($get_all_parent_akun_laba_rugi as $row) {
                        //   $id_akun = $row->id_kode_akuntansi;
                        ...
                        //   $query_akun = $this->db->query("SELECT * FROM kode_akuntansi WHERE kode_parent='" . $kode_akun . "' ORDER BY kode_akun ASC");
                        ...
                        //       $filter = "";
                        //     }else{
                        //       $filter = "AND periode='".$param_periode."'";
                        //     }

                        //     #ambil nilai mutasi jurnal
                        //     $query_jurnal = $this->db->query("SELECT sum(debet) as total_debet_mutasi, sum(kredit) as total_kredit_mutasi FROM jurnal_umum 
                        //       INNER JOIN jurnal_umum_detail ON jurnal_umum.no_bukti=jurnal_umum_detail.no_bukti 
                        //       WHERE id_kode_akuntansi='" . $id_akun_level_2 . "' 
                        //       ".$filter." 
                        //       GROUP BY id_kode_akuntansi")->row_array();
                        ...
                        //       $total_mutasi_akun =  $total_debet_mutasi;
                        //     } elseif ($saldo_normal == "Kredit") {
                        //       $total_mutasi_akun =  $total_kredit_mutasi;
                        //     }
                        //     // var_dump($query_jurnal);
                        //     $total_persub_akun = $total_persub_akun + $total_mutasi_akun;

                        //     echo '<tr role="row">
                        //                         <td>' . $nama_akun_level_2 . '</td>
                        //                         <td>';
                        //     if ($saldo_normal == 'Debet') {
                        //       echo number_format($total_mutasi_akun);
                        //     } else {
                        //       echo '';
                        //     }
                        //     echo '</td>
                        ...
                        //   $array[] = $total_persub_akun;

                        //   if (isset($array[0])) {
                        //     $total_parent_pendapatan = $array[0];
                        //   } else {
                        //     $total_parent_pendapatan = 0;
                        //   }

                        //   if (isset($array[1])) {
                        //     $total_parent_beban = $array[1];
                        //   } else {
                        //     $total_parent_beban = 0;
                        //   }

                        //   if (isset($array[2])) {
                        //     $total_parent_pajak = $array[2];
                        //   } else {
                        //     $total_parent_pajak = 0;
                        //   }


                        //   $laba_rugi_sebelum_pajak = $total_parent_pendapatan - $total_parent_beban;
                        //   $laba_rugi_setelah_pajak = $laba_rugi_sebelum_pajak - $total_parent_pajak;


                        //   echo '<tr role="row">
                        //                     <td align="right"><b>Total ' . ucfirst(strtolower($nama_akun)) . '</b></td>
                        //                     <td>';
                        //   if ($saldo_normal == 'Debet') {
                        //     echo '<b>' . number_format($total_persub_akun) . '</b>';
                        //   } else {
                        //     echo '';
                        //   }
                        //   echo '</td>
                        ...
                        //   if ($nama_akun == "BEBAN USAHA") {

                        //     echo '<tr role="row">
                        //                     <td align="right"><b>Laba (Rugi) Sebelum Pajak</b></td>
                        //                     <td><b>' . number_format($laba_rugi_sebelum_pajak) . '</b></td>
                        //                     <td></td>
                        //                     </tr>';
                        //   }
                        ...
                        //     echo '<tr role="row">
                        //                     <td align="right"><b>Laba (Rugi) Setelah Pajak</b></td>
                        //                     <td><b>' . number_format($laba_rugi_setelah_pajak) . '</b></td>
                        //                     <td></td>
                        //                     </tr>';
                        //   }
                        // }
 ...
 var table_pencarian = $('#myTable').DataTable({
                                            ...
                                            { extend:'excel', title: "Neraca" , footer: true }, 
                                            { extend:'pdf', orientation: 'landscape', title: "Neraca" , footer: true }, 
