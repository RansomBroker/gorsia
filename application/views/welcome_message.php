...
<html lang="en">
   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="assets/frontend/images/loading-img.gif" alt="">
      </div>
      <!-- END LOADER -->
      <section id="top">
         <header>
                        ...
                        <div class="right_top_section">
                           ...
                           <ul class="login">
                              <li class="login-modal">
                                 <a href="<?= site_url();?>?/Login" class="login"><i class="fa fa-user"></i>Login</a>
                              </li>
                              <!--<li>
                                 ...
                                 <nav class="navbar navbar-inverse">
                                    ...
                                    <div class="collapse navbar-collapse js-navbar-collapse">
                                       <ul class="nav navbar-nav">
                                          ...
                                          <li><a href="team.html">Info Sparing</a></li>
                                          <li><a href="news.html">Futsal</a></li>
                                          <li class="dropdown mega-dropdown">
                                             <a href="match" class="dropdown-toggle" data-toggle="dropdown">Badminton<span class="caret"></span></a>                
                                          ...
                                          <li><a href="blog.html">Fitnes</a></li>
            ...
            <div class="news">
               <div class="container">
                  <div class="heading-slider">
                     <p class="headline"><i class="fa fa-star" aria-hidden="true"></i> Informasi Terupdate :</p>
                     <!--made by vipul mirajkar thevipulm.appspot.com-->
                     <h1>
                     <a href="" class="typewrite" data-period="2000" data-type='[ "Promo! Booking Lapangan Futsal khusus liburan tahun baru paket 2 Jam free 1 Jam"]'>
                        ...
                        <div class="team-btw-match">
                           <ul>
                              <li>
                                 ...
                                 <span>Club Team A</span>
                              </li>
                              <li class="vs"><span>vs</span></li>
                              <li>
                                 <img src="images/img-04.png" alt="">
                                 <span>Club Team B</span>
                              </li>
                           </ul>
                        </div>
                     </div>
               ...
               <div class="col-lg-4 col-sm-4 col-xs-12">
                     ...
                     <div class="feature-matchs">
                        <table class="table table-bordered table-hover">
                           ...
                           <tbody>
                              <tr>
                                 <td>1</td>
                                 <td><img src="images/img-01_004.png" alt="">Futsal</td>
                                 <td>2 Jam</td>
                                 <td>150 K</td>
                                 <td>Weekend 175K</td>
                              </tr>
                              <tr>
                                 <td>2</td>
                                 <td><img src="images/img-02_002.png" alt=""><font size="1">Badminton</font></td>
                                 <td>1 Jam</td>
                                 <td>40K</td>
                                 <td>Weekend 50K</td>
                              </tr>
                              <tr>
                                 <td>3</td>
                                 <td><img src="images/img-03_003.png" alt="">Fitnes</td>
                                 <td>Member</td>
                                 <td>120K</td>
                                 <td>Per Bulan</td>
                              </tr>
                  ...
                  <div class="content-widget top-story" style="background: url(images/top-story-bg.jpg);">
                     <div class="top-stroy-header">
                        <h2>Top Member <a href="#" class="fa fa-fa fa-angle-right"></a></h2>
                  ...
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        ...
                        <div class="news-post-detail">
                           <span class="date">1 November 2023</span>
                           <h2><a href="blog-detail.html">Event Pertandingan Badminton Anak Usia 10 tahun</a></h2>
                           <p>Diramaikan oleh 20 sekolah dasar wilayah tropodo sidoarjo dan 50 peserta</p>
                        </div>
                     </div>
                     <div class="news-post-widget">
                        ...
                        <div class="news-post-detail">
                           ...
                           <h2><a href="blog-detail.html">Event Memperingati Hari Pahlawan</a></h2>
                           <p>Pertandingan futsal diikuti sekolah SMA dari wilayah Sedati Sidoarjo</p>
                        </div>
                     </div>
                  </div>
                  <div class="news-post-holder">
                     <div class="news-post-widget">
                        ...
                        <div class="news-post-detail">
                           ...
                           <h2><a href="blog-detail.html">Promo spesial menjelang akhir tahun</a></h2>
                           <p>Registrasi paket fitnes selama 1 tahun hanya 500ribu</p>
                        </div>
                     </div>
                  </div>
               </div>
      ...
      <footer id="footer" class="footer">
         ...
         <div class="footer-bottom">
            <div class="container">
               <p>Web by <a href="https://gortropodo.com/" target="_blank">GOR</a></p>
            </div>
         </div>
      </footer>
