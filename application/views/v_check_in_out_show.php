        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card" >
                    <h5 class="card-header">Detail Data Check In</h5>
                ...
                <div class="row">
                    <div class="col-md-6" >
                        <h4><u><b>Kode Member</b></u></h4>
                        <h5><?= $data->kodeMember ?></h5>
                    </div>
                    <div class="col-md-6" >
                    ...
                    <div class="col-md-6" >
                        <h4><u><b>Check In</b></u></h4>
                        <h5><?= $data->checkIn ?></h5>
                    </div>
                    <div class="col-md-6" >
                        <h4><u><b>Check Out</b></u></h4>
                        <h5><?= $data->checkOut ?></h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-5" >
                        <a href="<?= site_url(); ?>?/CheckInOut" class="btn btn-success">
