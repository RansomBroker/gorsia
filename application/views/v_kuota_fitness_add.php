      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper">
          <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form Data /</span> Kuota Fitness</h4>
            <div class="card">
              <h5 class="card-header">Kuota Fitness</h5>
              ...
              <div class="row">
                <div class="col-xl">
                  <div class="card mb-12">
                    <div class="card-body">
                      <form method="post" action="<?= base_url() ?>?/KuotaFitness/store">
                        <div class="row">
                          <div class="col-6">
                            <div class="mb-3">
