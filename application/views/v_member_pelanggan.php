...
<head>
  ...
  <title>Gorsia - Pelanggan Sewa  </title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master Data /</span> Pelanggan Sewa</h4>
              <div class="card" >
			 ...
			 <a href="<?= site_url() ?>?/MemberPelanggan/create" class="btn btn-primary" style="float: right;">
          ...
          <?php $no = 1; ?>
            ...
            <?php } ?>
						...
						<td>
            <a  href="<?php echo base_url() . "?/MemberPelanggan/delete/$key[id]" ?>"><i class="bx bx-trash me-2"></i> </a>
            <a  href="<?php echo base_url() . "?/MemberPelanggan/show/$key[id]" ?>"><i class="bx bx-show me-2"></i> </a>
            <a  href="<?php echo base_url() . "?/MemberPelanggan/edit/$key[id]" ?>"><i class="bx bx-edit me-2"></i> </a>
            </td>
					</tr>
					<?php $no++;
            } ?>
