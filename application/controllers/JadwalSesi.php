...
class JadwalSesi extends CI_Controller{
   ...
   if($hak_akses<>NULL && $status_menu=="Aktif") {
      $data = array('get_all_jadwal_sesi' => $this->M_jadwal_sesi->get_all_jadwal_sesi(), 'get_all_kategori' => $this->M_jadwal_sesi->get_all_kategori());
      $this->load->view('v_jadwal_sesi',$data);
   }
  ...
  public function insert_data(){
        ...
        $jam_sesi = $this->input->post('jam_sesi');
        ...
        #send to model
        $this->M_jadwal_sesi->insert_data($simpan_data);
  ...
  public function update_data(){
        ...
        #send to model
        $this->M_jadwal_sesi->update_data($id_lapangan, $simpan_data);
    ...
    public function delete_data()
    {
      ...
      $this->M_jadwal_sesi->delete_data($id_lapangan);
    }
